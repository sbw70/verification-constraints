...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        decision_complete_ns = time.monotonic_ns()
        ...
        display_start_ns = time.monotonic_ns()
        display(self.path, payload, canonical, request_repr, decision, reason)
        display_complete_ns = time.monotonic_ns()
        ...
        try:
            ...
            print(
                "LATENCY_STAGE " + json.dumps(timing, sort_keys=True),
                flush=True,
            )
