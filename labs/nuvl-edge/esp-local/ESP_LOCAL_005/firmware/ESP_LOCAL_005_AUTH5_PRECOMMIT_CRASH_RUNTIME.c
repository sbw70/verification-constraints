 ...
 *  "nonce":"b585661eb114a3762234f636ea8a49f3"}
 *
 ...
 *
 * Base64:
 * EFQOex8/4iO5pvJzbFbU/zQhU6Y1oHR6HMh6nYUM/91gM0OrCeOJ1nU2FAk7
 * aMrdREf89YzYN6z1Lc6IGK9YDA==
 */
static const uint8_t PROVIDER_SIGNATURE[64] = {
    0x10, 0x54, 0x0e, 0x7b, 0x1f, 0x3f, 0xe2, 0x23,
    0xb9, 0xa6, 0xf2, 0x73, 0x6c, 0x56, 0xd4, 0xff,
    0x34, 0x21, 0x53, 0xa6, 0x35, 0xa0, 0x74, 0x7a,
    0x1c, 0xc8, 0x7a, 0x9d, 0x85, 0x0c, 0xff, 0xdd,
    0x60, 0x33, 0x43, 0xab, 0x09, 0xe3, 0x89, 0xd6,
    0x75, 0x36, 0x14, 0x09, 0x3b, 0x68, 0xca, 0xdd,
    0x44, 0x47, 0xfc, 0xf5, 0x8c, 0xd8, 0x37, 0xac,
    0xf5, 0x2d, 0xce, 0x88, 0x18, 0xaf, 0x58, 0x0c,
};
...
static bool durable_consume(void)
{
     ...
     * nvs_set_blob has completed, but durable commit has NOT been requested.
     * Crash before nvs_commit and before any physical execution.
     */
    ESP_LOGE(TAG, "005_FAULT_PRE_COMMIT_ABORT");
    vTaskDelay(pdMS_TO_TICKS(100));
    abort();

    /* unreachable during this fault-injection build */
