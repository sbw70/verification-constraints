...
static const uint8_t EXPECTED_AUTHORITY_ID[NUVL_AUTHORITY_ID_LEN] = {
    0x52, 0x04, 0xcc, 0x27, 0x5c, 0xbb, 0x67, 0x00, 0x90, 0x25, 0xc7, 0xd4, 0xd8, 0x4f, 0x25, 0x94, 0xb8, 0xf6, 0x78, 0xb0, 0x90, 0x92, 0xd0, 0x91, 0xca, 0x44, 0x57, 0x6f, 0x04, 0x15, 0xa9, 0x04
};
...
static void fail_closed(const char *stage, esp_err_t err)
{
    ...
    ESP_LOGE(TAG, "007_AUTH1_PROVISION_FAIL_CLOSED");
}
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "ESP-LOCAL-007 Authority #1 explicit provisioning");
    ...
    if (verify_len != sizeof(verify) ||
        ...
        ESP_LOGE(TAG, "Authority #1 read-back validation failed");
        ESP_LOGE(TAG, "007_AUTH1_PROVISION_FAIL_CLOSED");
        return;
    }
    ...
    ESP_LOGI(
        TAG,
        "007_AUTH1_ID=5204cc275cbb67009025c7d4d84f2594b8f678b09092d091ca44576f0415a904"
    );
    ESP_LOGI(TAG, "007_AUTH1_DURABLE_UNSPENT_VERIFIED");
    ESP_LOGI(TAG, "007_AUTH1_PROVISION_PASS");
}
