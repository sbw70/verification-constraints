...
print("XIAO_SERVO_ACCEPT_RUN_START")
print("run_id=", run_id)
...
if result is None:
    ...
    print("result=FAIL")
    print("XIAO_SERVO_ACCEPT_RUN_END")
    raise SystemExit(1)
...
outcome_match = (
    decision == "accepted"
    and reason == "provider_admissible"
)

actuator_match = (
    actuator_attempted is True
    and actuator_command_completed is True
...
print("XIAO_SERVO_ACCEPT_RUN_SUMMARY")
