...
ENDPOINTS = {
    "esp32-xiao-servo-01": {
        ...
        "reason": "__NONEMPTY_FAILURE_REASON__",
...
print("ACT005_DUAL_OUTAGE_RUN_START")
print("run_id=", run_id)
...
print("ACT005_DUAL_OUTAGE_RUN_SUMMARY")
print(
    "expected_physical_behavior="
    "servo-01=NO_MOVE servo-02=NO_MOVE"
)
print(
...
print("result=", status)
print("ACT005_DUAL_OUTAGE_RUN_END")
