...
print("XIAO_SERVO_STALE_RUN_START")
print("run_id=", run_id)
...
if result is None:
    ...
    print("result=FAIL")
    print("XIAO_SERVO_STALE_RUN_END")
    raise SystemExit(1)
...
outcome_match = (
    decision == "denied"
    and reason == "stale_replay_malformed"
)
...
print("XIAO_SERVO_STALE_RUN_SUMMARY")
