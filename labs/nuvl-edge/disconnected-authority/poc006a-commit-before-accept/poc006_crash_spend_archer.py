...
ARTIFACT_PATH = Path(__file__).resolve().parent / "poc006_crash_artifact.json"

print("POC006_CRASH_SPEND_START")
...
print(
    "client_phase_result=",
    "EXPECTED_CRASH_NO_RESPONSE" if phase_pass else "FAIL",
)
print("POC006_CRASH_SPEND_END")
