...
SPENT_STATE_PATH = Path("/home/seth/poc006_spent_state_archer.json")
CRASH_STAGE_PATH = Path("/home/seth/poc006_crash_stage.txt")
...
def deny(reason, verified=False, artifact_id=None):
    return {
        ...
        "boundary": "poc006_crash_window_pi",
...
def main():
    ...
    print("POC006_CRASH_WINDOW_PI_BOUNDARY")
