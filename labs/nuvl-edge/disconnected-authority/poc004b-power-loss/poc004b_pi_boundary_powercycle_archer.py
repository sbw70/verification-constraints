...
SPENT_STATE_PATH = Path("/home/seth/poc004b_spent_state_powercycle_archer.json")
...
def deny(reason, verified=False, artifact_id=None):
    return {
        ...
        "boundary": "poc004b_powercycle_persistence_pi",
...
def main():
    ...
    print("POC004B_POWERCYCLE_PERSISTENCE_PI_BOUNDARY")
