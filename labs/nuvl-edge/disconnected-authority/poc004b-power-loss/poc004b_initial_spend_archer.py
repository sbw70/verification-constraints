...
print("POC004B_INITIAL_SPEND_START")
...
passed = (
    ...
    and result.get("reason") == "offline_artifact_admissible"
    and result.get("provider_verified") is True
    and result.get("provider_contacted_for_spend") is False
    and result.get("replay_state_persisted_before_accept") is True
...
print("replay_state_persisted_before_accept=", result.get("replay_state_persisted_before_accept"))
print("artifact_file_preserved=", artifact_preserved)
print("artifact_sha256=", artifact_hash)
print("result=", "PASS" if passed else "FAIL")
print("POC004B_INITIAL_SPEND_END")
